 ...
 *  private ImageView mSourImage;
 ...
 textBitmap = ImageUtil.drawTextsToLeftBottom(this, sourBitmap, new String[]{"时间：2017","地点：深圳南山区","人物：涛歌","事件：什么事情发生了？"}, 26, Color.WHITE, 0, 30);
...
/*mSourImage.setImageBitmap(sourBitmap);
        ...
        /*textBitmap = ImageUtil.drawTextToRightBottom(this, sourBitmap, "右下角\n时间：2017", 16, Color.RED, 0, 0);
...
textBitmap = ImageUtil.drawTextToLeftTop(this, watermarkBitmap, "左上角", 16, Color.RED, 0, 0);*/
